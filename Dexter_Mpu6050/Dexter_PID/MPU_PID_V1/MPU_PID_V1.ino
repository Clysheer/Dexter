...
#define SDA 21
// Parámetros del PID
#define KP 3.0          // Ganancia proporcional
#define KD 0.0          // Ganancia derivativa
...
#define PIN_MOTOR_A1 27
#define PIN_MOTOR_A2 14
...
void reposo() {
  while (!boton_presionado) {
    if (digitalRead(PIN_BOTON_START) == LOW ) { // Asegúrate de que el botón esté bien configurado
      boton_presionado = true;
      delay(2000); // Evitar debounce
    }
  }
}
